...
export function Pitch({ picks, playerMap, teamMap, livePoints }) {
  ...
  return (
    <div
      ...
      style={{
        background:
          'repeating-linear-gradient(180deg, rgba(255,255,255,0.05) 0px, rgba(255,255,255,0.05) 40px, rgba(0,0,0,0.05) 40px, rgba(0,0,0,0.05) 80px), radial-gradient(ellipse at center, #1c7a44 0%, #15642f 65%, #0f4a24 100%)',
